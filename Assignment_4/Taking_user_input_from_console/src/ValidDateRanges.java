     ...
     */
        public void findValidDateRanges(int[] signedDateValues,int[] presentDateValues){
            ...
            /*
               ...
               * If startDate is greater than presentDate then we have to find the closest anniversary
            ...
            */
            if(startDate.compareTo(presentDate)>0)
            {
                ...
                if(yearDifference>1){        //finding the closest anniversary
                   LocalDate previousStartDate=startDate.minusYears(1);
                   LocalDate previousEndDate=endDate.minusYears(1);
                    if(presentDate.compareTo(previousEndDate.plusMonths(6))<0)
                    {
