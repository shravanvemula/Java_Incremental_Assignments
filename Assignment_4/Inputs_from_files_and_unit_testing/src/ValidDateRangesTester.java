...
public class ValidDateRangesTester {
	...
	public void testSplitDatesAndFindValidDateRanges()
	{
		...
		assertEquals("input3 : check date ranges are correct ","01-12-2014 30-01-2015",input3.dateRanges.get(0));
		...
		assertEquals("input4 : check date ranges are correct ","13-10-2003 12-12-2003",input4.dateRanges.get(2));
