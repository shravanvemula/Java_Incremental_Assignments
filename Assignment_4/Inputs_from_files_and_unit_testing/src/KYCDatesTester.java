...
public class KYCDatesTester {
	...
	public void testStoreDatesInput()
	{
		...
		assertEquals("datesInput4 : check numberOfDates is correct ", 4, datesInput4.getNumberOfDates());
		assertEquals("datesInput4 : check elements added to signedDayDates is correct ","12-12-2000",datesInput4.signedDayDates.get(0));
		assertEquals("datesInput4 : check elements added to signedDayDates is correct ","12-12-2000",datesInput4.signedDayDates.get(1));
		assertEquals("datesInput4 : check size of signedDayDates is correct ", 4, datesInput4.signedDayDates.size());
		assertEquals("datesInput4 : check elements added to currentDayDates is correct ","11-10-2003",datesInput4.currentDayDates.get(2));
		assertEquals("datesInput4 : check elements added to currentDayDates is correct ","13-10-2003",datesInput4.currentDayDates.get(3));
		assertEquals("datesInput4 : check size of currentDayDates is correct ", 4, datesInput4.currentDayDates.size());
